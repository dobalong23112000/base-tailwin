...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="float-right w-fit mx-4 flex rounded-2xl bg-white-5 border-gray-200 z-50 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row">
        ...
        <div
          ...
          } items-center justify-between w-full gap-4 px-2 py-2 lg:flex shadow-theme-md rounded-2xl`}
        >
